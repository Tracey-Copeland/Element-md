        ...
        <div className="products-row">
            ...
            <div className="product-one">
                ...
                <div className="p1-desc">
                    ...
                    <h2>Smoked Almond Artisian Chocolates</h2>
            ...
            <div className="product-two">
                ...
                <div className="p2-desc">
                    ...
                    <h2>Caramel Macchiato Artisian Chocolates</h2>
                ...
                <div className="btn-row">
                    ...
                    <Link  to="/lux/caramel-macciato-DC">
            ...
            < div className="product-three">
                ...
                <div className="p3-desc">
                    ...
                    <h2>Sea Salt Caramel Artisian Chocolates</h2>
                ...
                <div className="btn-row">
                    ...
                    <Link to="/lux/seasalt-caramel-DC">
